...
This site is intended to serve as a companion to @grimmerTextDataNew2021, an excellent book on thinking about text as data, which makes a deliberate choice (wisely, in my view) to omit coding instructions on how to implement the methods they discuss. Books with code, particularly in fast-evolving subfields, can quickly become dated. Thus the need for this supplement, which was developed with my students during our Summer 2022 Text As Data course at the University of Georgia.

This site is divided into three sections, which correspond to the three stages of any text-as-data workflow:
...
2.  **Clean The Text:** How to represent large amounts of text quantitatively, and what choices you need to make during the preprocessing stage.
3.  **Model The Text:** How to choose a model to fit your objective, be it prediction, classification, causal inference, or exploration.
