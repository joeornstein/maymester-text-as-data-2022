...
Note LDA requires a matrix of counts, just like the [multinomial bag of words model](multinomial-model.html).
...
Surprise, surprise. The most common term in each topic is "Lautenberg". Instead of looking at the terms with the highest probability in each bag, let's look at the terms that are the most *over-represented*, compared to their probability in the average topic.
