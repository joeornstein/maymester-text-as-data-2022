...
We'd like not just to count the frequency of words, but also get a sense of what the words *mean*. In a [bag of words representation](bag-of-words.html), we treat the words "president" and "executive" as having completely unique meaning. By comparison, a word embeddings approach encodes the fact that these words have some overlapping meaning by placing them close together in a vector space.
