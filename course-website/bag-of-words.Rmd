...
Let's demonstrate this workflow using the State of the Union speeches application from Chapter 5. Our objective is to describe what words presidents when discussing the topic of manufacturing.
...
Notice that the `unnest_tokens()` function converts all the words to lower case. We now have a dataframe where the unit of analysis is the sentence, containing every sentence in State of the Union speeches from 1790 to 2016 containing a mention of manufacturing.
