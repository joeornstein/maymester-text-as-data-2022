...
\subsection*{Day 5: Text Reuse}

\textit{Let's take a model designed to detect plagiarism and use it to see how ideas spread in political texts over time.}
...
\subsection*{Day 6: Sentiment Analysis (Make this keyword and split out the supervised learning)}
...
\subsection*{Day 7: Word Embeddings}
...
\subsection*{Day 13: Crowd-Coding}
